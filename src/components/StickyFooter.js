export const StickyFooter = () => {
  return `
    <!-- Desktop Floating Campaign Banner -->
    <a href="/#contact" class="floating-campaign-banner" aria-label="国の補助金で賢くお得にリフォーム">
      <img src="/campaign-banner.jpg" alt="国の補助金で賢くお得にリフォーム" class="floating-campaign-img">
    </a>
    ...
    <style>
      /* Floating Campaign Banner - Desktop */
      ...
      .floating-campaign-banner:hover {
